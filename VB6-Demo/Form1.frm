...
Private Sub TaskDialog2_DialogConstucted(ByVal hWnd As Long)
Debug.Print "TaskDialog2_DialogConstucted"

End Sub

Private Sub TaskDialog2_DialogCreated(ByVal hWnd As Long)
...
Private Sub TaskDialog2_DropdownButtonClicked(ByVal hWnd As Long)
...
Private Sub TaskDialogSC_DropdownButtonClicked(ByVal hWnd As Long)
